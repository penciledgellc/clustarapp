...
} elseif ($_instance->childHasBeenRendered('z0DdMYu')) {
    $componentId = $_instance->getRenderedChildComponentId('z0DdMYu');
    $componentTag = $_instance->getRenderedChildComponentTagName('z0DdMYu');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('z0DdMYu');
} else {
    $response = \Livewire\Livewire::mount('page-builder.footer-block', ['pageId' => $footer_settings['page_id'],'blockKey' => $footer_settings['block_key'],'styleCss' => $footer_settings['style_css'],'siteView' => true,'page_id' => $footer_settings['page_id'],'block_key' => $footer_settings['block_key'],'settings' => $footer_settings['settings'],'style_css' => $footer_settings['style_css'],'site_view' => true]);
    $html = $response->html();
    $_instance->logRenderedChild('z0DdMYu', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php endif; ?>
...
<?php /**PATH /Applications/MAMP/htdocs/getclustar/resources/views/errors/minimal.blade.php ENDPATH**/ ?>