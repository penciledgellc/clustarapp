<div class="tab-pane fade" id="block-settings" wire:ignore.self>
    <?php if(file_exists(resource_path('views/livewire/pagebuilder/settings/'.$block_id.'.blade.php'))): ?>
        <div class="at-components-content">
            <?php echo $__env->make('livewire/pagebuilder/settings/'.$block_id, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        <?php else: ?>
           <div class="at-empty-block-settings">
                <span><?php echo e(__('pages.no_block_settings')); ?></span>
           </div>
        <?php endif; ?>
</div>   
    ...
    <script>
        document.addEventListener('livewire:load', function () {
            ...
            document.addEventListener('initTinyMce', event => {
                ...
                setTimeout(() => {
                    tinymce.init({
                        ...
                        "removeformat | code ",
                        content_css: ["<?php echo e(asset('pagebuilder/css/tinymce/tinymce.css')); ?>"],
            ...
            $(document).on('click','.at_remove_file', function(e){
                ...
                if(input){
                    input.val('');
                    window.livewire.find('<?php echo e($_instance->id); ?>').set('upload_files.'+file_name.toString(), '');
                    window.livewire.find('<?php echo e($_instance->id); ?>').set('settings.'+key.toString(),'')
                    input.change();
                }
            });
...
<?php $__env->stopPush(); ?>
   <?php /**PATH /Applications/MAMP/htdocs/getclustar/resources/views/livewire/pagebuilder/block-setting.blade.php ENDPATH**/ ?>