...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('LjPzAG2')) {
    $componentId = $_instance->getRenderedChildComponentId('LjPzAG2');
    $componentTag = $_instance->getRenderedChildComponentTagName('LjPzAG2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('LjPzAG2');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('LjPzAG2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php else: ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /Applications/MAMP/htdocs/getclustar/resources/views/livewire/admin/disputes/disputes.blade.php ENDPATH**/ ?>