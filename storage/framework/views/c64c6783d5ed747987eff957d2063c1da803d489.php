        ...
        $('.update-section-settings').on('click', function(e){
            ...
            if( form_id !='' ){
                ...
                $.ajax({
                    ...
                    method: 'post',
                    data: { section_key:section_key, data: $(`#${form_id}`).serialize() },
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make(config('optionbuilder.layout'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/getclustar/vendor/larabuild/optionbuilder/src/../resources/views/index.blade.php ENDPATH**/ ?>