<div class="col-lg-4 col-md-12 tb-md-40">
    <div class="tb-dbholder tb-packege-setting">
        <div class="tb-dbbox tb-dbboxtitle">
            <?php if($editMode): ?>
                <h5> <?php echo e(__('taxonomy.update_tag')); ?></h5>
            <?php else: ?> 
                <h5> <?php echo e(__('taxonomy.add_tag')); ?></h5>
            <?php endif; ?>
        </div>
        <div class="tb-dbbox">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group tb-dbtnarea">
                            <a href="javascript:void(0);" wire:click.prevent="update" class="tb-btn"> 
                                <?php if($editMode): ?> 
                                    <?php echo e(__('taxonomy.update_tag')); ?>
...
</div><?php /**PATH /Applications/MAMP/htdocs/getclustar/resources/views/livewire/admin/taxonomies/tags/update.blade.php ENDPATH**/ ?>