...
<script defer src="<?php echo e(asset('admin/js/main.js')); ?>"></script><?php /**PATH /Applications/MAMP/htdocs/getclustar/resources/views/layouts/admin/footer_scripts.blade.php ENDPATH**/ ?>