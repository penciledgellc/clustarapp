...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('sV3GlTr')) {
    $componentId = $_instance->getRenderedChildComponentId('sV3GlTr');
    $componentTag = $_instance->getRenderedChildComponentTagName('sV3GlTr');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('sV3GlTr');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('sV3GlTr', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php else: ?>
...
} elseif ($_instance->childHasBeenRendered('E89L4Wc')) {
    $componentId = $_instance->getRenderedChildComponentId('E89L4Wc');
    $componentTag = $_instance->getRenderedChildComponentTagName('E89L4Wc');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('E89L4Wc');
} else {
    $response = \Livewire\Livewire::mount('earnings.invoices', ['className' => 'tk-dbinvoice']);
    $html = $response->html();
    $_instance->logRenderedChild('E89L4Wc', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php endif; ?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('eH5lGnj')) {
    $componentId = $_instance->getRenderedChildComponentId('eH5lGnj');
    $componentTag = $_instance->getRenderedChildComponentTagName('eH5lGnj');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('eH5lGnj');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('eH5lGnj', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app',['include_menu' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/getclustar/resources/views/front-end/dashboard/dashboard.blade.php ENDPATH**/ ?>