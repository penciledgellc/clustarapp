...
<?php if($status): ?>
    <div <?php echo e($attributes->merge(['class' => 'tk-verifyemail_alert'])); ?>>
        <?php echo e($status); ?>

    </div>
<?php endif; ?>
<?php /**PATH /Applications/MAMP/htdocs/getclustar/resources/views/components/auth-session-status.blade.php ENDPATH**/ ?>