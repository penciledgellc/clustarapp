...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('XsioVCj')) {
    $componentId = $_instance->getRenderedChildComponentId('XsioVCj');
    $componentTag = $_instance->getRenderedChildComponentTagName('XsioVCj');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('XsioVCj');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('XsioVCj', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php echo $__env->make('layouts.app',['include_menu' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/getclustar/resources/views/front-end/sellers/search-sellers.blade.php ENDPATH**/ ?>