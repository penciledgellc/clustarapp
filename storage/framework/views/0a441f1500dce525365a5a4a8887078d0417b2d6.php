...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('WJOwGUs')) {
    $componentId = $_instance->getRenderedChildComponentId('WJOwGUs');
    $componentTag = $_instance->getRenderedChildComponentTagName('WJOwGUs');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('WJOwGUs');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('WJOwGUs', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?> 
		</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', ['include_menu' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/getclustar/resources/views/front-end/gig/gig-gridview.blade.php ENDPATH**/ ?>