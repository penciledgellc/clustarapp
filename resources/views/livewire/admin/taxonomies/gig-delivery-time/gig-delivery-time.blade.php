<div class="tb-main">
    <div class ="row">
        @include('livewire.admin.taxonomies.gig-delivery-time.update')
        <div class="col-lg-8 col-md-12 tb-md-60">
            <div class="tb-dhb-mainheading">
                <h4> {{ __('gig.delivery_times') }}</h4>
                <div class="tb-sortby">
            ...
            <div class="tb-disputetable">
                @if(!empty($delivery_times) && $delivery_times->count() > 0)
                    <table id="tag_table" class="table tb-table tb-dbholder">
                        ...
                        <tbody>
                            @foreach($delivery_times as $single)
                                <tr>
                        ...
                        {{ $delivery_times->links('pagination.custom') }}  
                    @else
    ...
    <script>
        ...
        document.addEventListener('livewire:load', function () {
            ...
            $(document).on('change', '#tag_table input:checkbox', function(event){
                ...
                @this.set('selectedTimes', ids, true)
                if(isSelected){
